...
public class ArrayCuentaCorriente {
	 ...
	 * @return True o false segun si se ha llevado a cabo la operacion o no
	 */
	public static boolean cambiarNombre(CuentaCorriente cuenta, String nombre) {
	...
	/**
	 * Modifica el saldo de la cuenta corriente que le indicamos en el
	 * parametro sumandole la cantidad de dinero
	...
	/**
	 * Modifica el saldo de la cuenta corriente que le indicamos en el
	 * parametro restandole la cantidad de dinero
	 * @param cuenta Cuenta corriente a la que cambiaremos el saldo
